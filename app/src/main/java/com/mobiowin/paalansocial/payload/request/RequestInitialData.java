...
public class RequestInitialData {
    ...
    public static RequestInitialData get(String latitude, String longitude, String lastsyncdate) {
        ...
        RequestInitialData requestSlidingBanner = new RequestInitialData();
