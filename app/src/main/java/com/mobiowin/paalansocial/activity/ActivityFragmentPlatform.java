...
import com.mobiowin.paalansocial.fragments.FragmentAboutUs;
import com.mobiowin.paalansocial.fragments.FragmentCreateAchievement;
import com.mobiowin.paalansocial.fragments.FragmentDashBorad;
import com.mobiowin.paalansocial.fragments.FragmentIndDashboard;
import com.mobiowin.paalansocial.fragments.FragmentMyProfile;
import com.mobiowin.paalansocial.fragments.FragmentNotifications;
import com.mobiowin.paalansocial.fragments.FragmentViewAchievement;
import com.mobiowin.paalansocial.fragments.FragmentViewDetailsAchievement;
import com.mobiowin.paalansocial.fragments.FragmentViewDetailsRequest;
import com.mobiowin.paalansocial.fragments.FragmentViewEvent;
import com.mobiowin.paalansocial.fragments.FragmentViewGroups;
import com.mobiowin.paalansocial.fragments.FragmentViewRequest;
import com.mobiowin.paalansocial.helper.DialogPopupListener;
...
import com.mobiowin.paalansocial.utils.Config;
...
import com.mobiowin.paalansocial.utils.TextViewOpenSansSemiBold;
import com.mobiowin.paalansocial.R;
import com.mobiowin.paalansocial.fragments.FragmentConnectWithUs;
import com.mobiowin.paalansocial.fragments.FragmentCreateEvent;
import com.mobiowin.paalansocial.fragments.FragmentCreateRequest;
import com.mobiowin.paalansocial.fragments.FragmentViewDetailsEvent;
                    ...
                    if (response.body().getStatus().equals("success")) {
                        ...
                        if(response.body().getData()[0].getOrgreclist().length>0) {
                            ...
                            for (int i = 0; i < response.body().getData()[0].getOrgreclist().length; i++) {
                                Log.e(TAG,"response get event: "+response.body());
